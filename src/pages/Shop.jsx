...
export default function Shop() {
  ...
  const fullInventory = [
    ...
    {
      id: 102,
      title: 'Banarasi Soft Silk Saree',
    ...
    {
      id: 103,
      title: 'Festive Collection Georgette',
      brand: 'GG FASHION',
      price: '1531',
      img: img3,
    },
    {
      id: 104,
      title: 'Vichitra Silk - Full Border',
      brand: 'DESIGNER LOFT',
      price: '4368',
      img: img4,
    },
    {
      id: 201,
      title: 'Embellished Gown - Evening Wear',
      brand: 'GG FASHION',
      price: '5500',
      img: img5,
    },
    ...
    <div className="container my-5 pt-3">
      <div className="border-bottom pb-3 mb-4">
        ...
        <p className="text-muted m-0 small">
          Browse our inventory matching premium aesthetic standards
        </p>
      </div>
